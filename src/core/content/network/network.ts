import type { NetworkSource } from '@core/content/types'
...
export const SOURCE = {
    ...
    detail: 'These are the fourteen nodes of the planned Rattlesnake Ridge branch, shaped exactly like the live feed will be. Nothing here has been in the field. When the first node reports, this banner disappears and the numbers become real.',
    endpoint: '/api/network.json',
} as const satisfies NetworkSource

export function isSampleNetwork(source: NetworkSource): boolean {
