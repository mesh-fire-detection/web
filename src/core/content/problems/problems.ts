...
export const PROBLEMS = [
    {
        ...
        tried: [
            {
                ...
                outcome:
                    'Wrong quantity. Containment time is dominated by response, not detection.',
            },
            {
        ...
        candidate: {
            ...
            detail: 'Ignition-time estimates and dispatch timestamps for every wildland incident in a five-year window, for a single district in the Cascade foothills.',
            blocker:
                'Request drafted, not yet filed. Needs someone who has done one of these before.',
        },
        closesWhen:
    ...
    },
    {
        ...
        candidate: {
            ...
            detail: 'Base nodes deployed in pairs on facing ridges, each pair cross-linked, so any single loss leaves a path. Costs about 40% more Base nodes, no more Cellular nodes.',
            blocker:
...
] as const satisfies readonly OpenProblem[]
