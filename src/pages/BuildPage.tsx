            ...
            <Section space='md' tone='raised' bordered id='bom'>
                <Stack gap={6}>
                    ...
                    <Callout title='One substitution will cost you a node' tone='warn'>
                        Print the shell in ASA, not PLA. A PLA enclosure in direct sun softens and
                        warps by its second summer, and every seal on it fails at once. It is the
                        single most common way a build of this kind dies quietly a year after you
                        install it.
                    </Callout>
                </Stack>
            </Section>
            ...
            <Section space='md' bordered id='enclosures'>
                <Stack gap={6}>
                    ...
                    <Text size='sm' tone='warn' measure={86}>
                        The enclosure geometry is not published yet. Rather than serve you a file
                        that is not there, these link to the hardware repository — the print
                        settings below are current, the meshes are not.
                    </Text>
                        ...
                        <Box tone='surface' padding={5} radius='md'>
                            <Stack gap={4}>
                                ...
                                <DescriptionList columns={1}>
                                    <DescriptionItem term='Material'>
                                        ASA. ABS works; PLA does not.
                                    </DescriptionItem>
                                    <DescriptionItem term='Layer height'>0.2 mm</DescriptionItem>
                                    <DescriptionItem term='Walls'>
                                        4 perimeters, 30% gyroid infill
                                    </DescriptionItem>
                                    <DescriptionItem term='Supports'>
                                        None required in the shipped orientation
                                    </DescriptionItem>
                                    <DescriptionItem term='Post-processing'>
                                        Silicone the cable pass-through; nothing else
                                    </DescriptionItem>
                                </DescriptionList>
                            </Stack>
                        </Box>
                        ...
                        <Box tone='surface' padding={5} radius='md'>
                            <Stack gap={4}>
                                ...
                                <Text size='sm' tone='muted'>
                                    Dust-tight and rated against low-pressure water jets from any
                                    direction. It is a design target for these parts, not a
                                    certification — nobody has taken one of these shells to a test
                                    house.
                                </Text>
                                <Text size='sm' tone='warn'>
                                    Soak-test every node outdoors for 48 hours before you carry it
                                    somewhere remote.
                                </Text>
                            </Stack>
                        </Box>
                ...
                <Stack gap={6}>
                    ...
                    <Box tone='surface' padding={5} radius='md'>
                        <Stack gap={4}>
                            ...
                            <Text size='sm' tone='muted'>
                                The network runs Long / Fast. Slower presets buy range and spend
                                airtime — and airtime is the thing that caps how many nodes a branch
                                can carry.
                            </Text>
                        </Stack>
                    </Box>
                ...
                <Stack gap={5}>
                    ...
                    <List marker='number' gap={4}>
                        <ListItem>
                            ...
                            Get it in writing from whoever owns the ground. A node on someone else's
                            ridge is their node, legally and practically.
                        </ListItem>
                        <ListItem>
                            <Text as='span' weight={600}>
                                Radio rules.
                            </Text>{' '}
                            US915 under FCC Part 15 caps radiated power. The presets ship compliant;
                            if you change power or antenna gain, that is on you.
                        </ListItem>
                        <ListItem>
                            <Text as='span' weight={600}>
                                Wilderness.
                            </Text>{' '}
                            Designated wilderness has rules about installed equipment that predate
                            all of this. Read them before you carry hardware in.
                        </ListItem>
                    </List>
                </Stack>
            </Section>
