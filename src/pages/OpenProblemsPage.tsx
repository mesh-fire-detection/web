            ...
            <Section space='sm'>
                <Stack gap={5}>
                    ...
                    <Text tone='muted' measure={88}>
                        This page is unusual and deliberately so. Most hardware projects publish
                        what works and stay quiet about what does not, which reads as confidence and
                        produces spectators. The list below is the actual state of the project. If
                        one of these is your field, you can close it faster than we can.
                    </Text>
                </Stack>
            </Section>
                ...
                <Grid columns={2} minColumnWidth={320} gap={7} align='start'>
                    <Stack gap={4}>
                        ...
                        <Text tone='muted' measure={70}>
                            Open a discussion on the problem you want. Say what you would try and
                            what you would need. When you have a result — including a negative one —
                            it goes on this page under "what has been tried", with your name on it.
                        </Text>
                        <Text tone='muted' measure={70}>
                            Negative results are worth as much as positive ones here. Half the
                            entries above are things that did not work, and each one saved somebody
                            a month.
                        </Text>
                    </Stack>
                    ...
                    <Box tone='surface' padding={6} radius='md'>
                        <Stack gap={4}>
                            ...
                            <Text size='sm' tone='muted'>
                                No forum — discussion happens on GitHub and Discord, where the
                                people who would answer already are. No donate button until a node
                                has survived a winter outdoors. No detection-time claim until the
