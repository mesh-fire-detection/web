                ...
                <Stack gap={8}>
                    <Stack gap={5} align='center'>
                        ...
                        <Text size='lg' tone='muted' align='center' measure={68}>
                            Wildfire detection fails because coverage is expensive. Make each unit
                            cheap enough to lose and you can cover the ground that matters. Here is
                            the bill of materials, the network, and everything we have not solved.
                        </Text>
                ...
                <Grid columns={2} minColumnWidth={320} gap={7} align='start'>
                    <Stack gap={4}>
                        ...
                        <Text tone='muted' measure={70}>
                            The project's first goal is to reduce wildfire detection time. Reduce it
                            from what? We refuse to put an unbacked number on this page — a specific
                            claim you cannot defend is the fastest way to lose the agency people
                            this network needs.
                        </Text>
                        <Text tone='muted' measure={70}>
                            So the honest state is: unmeasured. A public records request for one
                            Washington fire district is drafted and not yet filed. When the median
                            comes back, it goes here, with the raw records next to it.
                        </Text>
                        <Row gap={3}>
                            <ButtonLink
                    ...
                    <Box tone='surface' padding={6} radius='md'>
                        <Stack gap={5}>
                            ...
                            <Stack gap={4}>
                                <BaselineRow
                                    label='District'
                                    value='One named Washington district'
                                />
                                <BaselineRow
                                    label='Quantity'
                                    value='Ignition to first dispatched unit'
                                />
                                <BaselineRow label='Window' value='Five years of incidents' />
                                <BaselineRow
                                    label='Method'
                                    value='Published alongside the raw records'
                                />
                ...
                <Container width='narrow'>
                    <Stack gap={5} align='center'>
                        ...
                        <Text tone='muted' align='center' measure={66}>
                            Every part is linked to a supplier with a current price. The enclosure
                            STLs and the Meshtastic config presets are hosted here, not behind a
                            form. If you have to ask a question to build a node, that is a bug in
                            this site.
                        </Text>
                        <Row gap={3} justify='center'>
                            <ButtonLink
