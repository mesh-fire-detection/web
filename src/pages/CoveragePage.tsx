    ...
    >
      ...
      <Section space="md" tone="raised" bordered>
        <Stack gap={6}>
          ...
          <Grid columns={2} minColumnWidth={320} gap={6} align="start">
            <Box tone="surface" padding={5} radius="md">
              <Stack gap={4}>
                ...
                <List marker="dash" gap={2}>
                  ...
                  <ListItem size="sm">A distance-proportional excess loss for vegetation and clutter.</ListItem>
                  <ListItem size="sm">The 4/3-earth radio horizon from both antenna heights.</ListItem>
                  <ListItem size="sm">First Fresnel zone radius, so you know how much clearance to hold.</ListItem>
                  <ListItem size="sm">Receiver sensitivity for each Meshtastic preset.</ListItem>
                </List>
              </Stack>
            </Box>
            ...
            <Box tone="surface" padding={5} radius="md">
              <Stack gap={4}>
                ...
                <List marker="dash" gap={2}>
                  <ListItem size="sm">Terrain. There is no elevation data in this page.</ListItem>
                  <ListItem size="sm">Diffraction over an obstruction, which can save a link this calculator calls dead.</ListItem>
                  <ListItem size="sm">Ground reflection and multipath.</ListItem>
                  <ListItem size="sm">Seasonal foliage, which is why the fade margin defaults to 10 dB.</ListItem>
                  <ListItem size="sm">Interference from anything else on the band.</ListItem>
                </List>
              </Stack>
            </Box>
          </Grid>
          ...
          <Callout title="Use this to rule sites out, not to commit to one" tone="warn">
            If the calculator says a hop does not close, believe it — the real world only adds loss.
            If it says the hop closes, that is a hypothesis you confirm against terrain and then on
            site with two nodes and a walk.
          </Callout>
        </Stack>
      </Section>
      ...
      <Section space="md" tone="sunken" bordered>
        <Grid columns={2} minColumnWidth={320} gap={7} align="start">
          <Stack gap={4}>
            <SectionHead eyebrow="The maths" title="Everything this page computes" size="lg" />
            <Text tone="muted" measure={70}>
              No black box. These are the four equations behind every number on this page, and the
              implementation is a hundred lines you can read in the repository.
            </Text>
          </Stack>
          ...
          <DescriptionList columns={1}>
            ...
            <DescriptionItem term="Link closes when">
              Received power ≥ preset sensitivity + your fade margin, and d ≤ radio horizon
            </DescriptionItem>
          </DescriptionList>
        </Grid>
      </Section>
      ...
      <Section space="sm">
        <Row justify="center">
          <Text size="sm" tone="faint" align="center" measure={80}>
            Sensitivity figures are typical SX1262 values for each spreading factor and bandwidth.
            Your radio will differ by a decibel or two, which is well inside the fade margin.
          </Text>
        </Row>
      </Section>
    </Page>
